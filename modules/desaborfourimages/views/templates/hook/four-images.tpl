  ...
  <div class="four-images-container">
    <div class="four-images-wrapper">
      ...
      <a href="10-wine-cellar" class="image-block">
        <div class="image-block">
          <img src="{$module_dir}views/img/img_2.jpg" alt="Example Image" />
      ...
      <a href="#" class="image-block">
        <div class="image-block">
          <img src="{$module_dir}views/img/img_4.jpg" alt="Example Image" />
...
<div class="content-grid">
  ...
  <div class="image-block">
    <img src="{$module_dir}views/img/golf.jpeg" alt="Example Image" />
  </div>
  <div class="text-block">
